...
namespace ShopOnline.Api.Extensions
{
    ...
    {
        public static IEnumerable<ProductCategoryDto> ConvertToDto(this IEnumerable<ProductCategory> productCategoreies)
        {
            return (from productCategory in productCategoreies
